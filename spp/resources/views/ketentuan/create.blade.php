...
<div class="container">
 ...
 <div class="form-group">
    <label for="exampleInputEmail1">Ketentuan denda</label>
    <input type="text" id="rupiah2"  value="{{ old('denda')}}" required name="denda" autofocus class="form-control @error('denda') is->invalid @enderror" aria-describedby="denda" placeholder="ketentuan denda"> 
  </div>
