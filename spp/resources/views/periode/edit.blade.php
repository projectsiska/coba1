...
<div class="container">
 ...
 @csrf
  ...
  <div class="form-group">
    ...
    <input type="text" value="{{ old('bulan',$periode->bulan)}}" required name="bulan" autofocus class="form-control @error('bulan') is->invalid @enderror" id="bulan" aria-describedby="bulan" placeholder="Bulan Periode"> 
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" required  value="{{ old('tahun',$periode->tahun)}}" name="tahun" class="form-control" id="tahun" placeholder="Nama Tahun">
  </div>
